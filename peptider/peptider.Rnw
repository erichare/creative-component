...
<<coverage_plot,fig.width=6, fig.height=4, out.width='0.7\\textwidth', message=FALSE, fig.align="center", fig.cap="Overview of coverage rates across different hexapeptide library schemes of varying size.">>=
